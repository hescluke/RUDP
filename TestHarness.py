...
def tests_to_run(forwarder, filename="README"):
    from tests import BasicTest, RandomDropTest, MyShuffleOrderTest, MyRepeatedlyArriveTest, MyDataErrorTest, SackRandomDropTest, \
        MySackShuffleOrderTest, MySackRepeatedlyArriveTest, MySackDataErrorTest
    ...
    # 失序到达
    MyShuffleOrderTest.MyShuffleOrderTest(forwarder, filename)
    MySackShuffleOrderTest.MySackShuffleOrderTest(forwarder, filename)
    # 数据传输出错
    MyDataErrorTest.MyDataErrorTest(forwarder, filename)
    MySackDataErrorTest.MySackDataErrorTest(forwarder, filename)
    # 重复到达
    MyRepeatedlyArriveTest.MyRepeatedlyArriveTest(forwarder, filename)
    MySackRepeatedlyArriveTest.MySackRepeatedlyArriveTest(forwarder, filename)
